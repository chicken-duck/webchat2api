...
export type ImageTaskStatus = "queued" | "running" | "success" | "error" | "cancelled";
...
export async function cancelImageTask(key: string) {
...
export async function retryImageTask(key: string) {
